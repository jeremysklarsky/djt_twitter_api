...
class HashtagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hashtag" do
    assert_difference('Hashtag.count') do
      post hashtags_url, params: { hashtag: { text: @hashtag.text, year: @hashtag.year } }, as: :json
    end
  ...
  test "should update hashtag" do
    patch hashtag_url(@hashtag), params: { hashtag: { text: @hashtag.text, year: @hashtag.year } }, as: :json
    assert_response 200
  end
